                    ...
                    <form class="form-horizontal" action="{{ URL::to('/admin/department_subject') }}" method="post" enctype="multipart/form-data">
                        ...
                        <fieldset>
                                ...
                                <div class="col-md-8">
                                    <select name="department_id" id="department_id" class="form-control">
                                        @foreach($departments as $department)
                                            <option value="{{ $department->id }}" @if($department->id == $department_subject->department_id) selected @endif>{{ $department->department_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <select name="subject_id" id="subject_id" class="form-control">
                                        @foreach($subjects as $subject)
                                            <option value="{{ $subject->id }}" @if($subject->id == $department_subject->subject_id) selected @endif>{{ $subject->subject_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input value="{{ $department_subject->group }}" type="text" class="form-control" id="group" placeholder="Group" name="group">
                                </div>
                            </div>
